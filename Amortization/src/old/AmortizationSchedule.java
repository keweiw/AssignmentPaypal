...
// Exercise Details: // Build an amortization schedule program using Java. 
...
public class AmortizationSchedule {
	...
	private static final double[] borrowAmountRange = new double[] {

	0.01d, 1000000000000d };

	private static final double[] aprRange = new double[] {
	...
	private long calculateMonthlyPayment() {
		...
		// calculate J monthlyInterest = apr / monthlyInterestDivisor;
	...
	// The first column identifies the payment number. // The second column
	// contains the amount of the payment.
	...
	public AmortizationSchedule(double amount, double interestRate,
	...
	public static void main(String[] args) {
		...
		try {
			...
			AmortizationSchedule(amount, apr, years);
